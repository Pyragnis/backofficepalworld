...
const UserOrders = () => {
  ...
  const handlePageChange = (pageNumber) => {
    if (pageNumber > 0 && pageNumber <= Math.ceil(orders.length / ordersPerPage)) {
    ...
    <div className="flex flex-col md:flex-row">
      ...
      <div className="flex-1 p-4 md:p-6">
        ...
        <div className="flex flex-col md:flex-row mb-4">
          ...
          />
          <div className="flex">
            <button onClick={handleSearch} className="bg-sky-600 text-white px-4 py-2 rounded-lg mr-2 w-full md:w-auto">
              Rechercher
            </button>
            ...
            <table className="min-w-full bg-white border border-gray-300 rounded-lg shadow-sm">
              <thead>
                <tr className="bg-gray-100">
                  <th className="py-3 px-2 md:px-4 text-left border-b font-semibold">ID</th>
